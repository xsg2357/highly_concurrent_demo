...
//                        tryAcquire(long timeout, TimeUnit unit) 尝试获取一个许可 等待时间设置
//                        tryAcquire(int permits) 尝试获取许可数
//                        tryAcquire(int permits, long timeout, TimeUnit unit) 尝试获取许可数和等待时间设置合并在一起
                        test(threadNum);
